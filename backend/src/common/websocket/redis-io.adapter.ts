...
// Fans a message published from one API pod out to sockets connected to
// another (architecture §08) — without this, `NotificationsGateway.pushToUser`
// only reaches clients on the same process that enqueued the job.
